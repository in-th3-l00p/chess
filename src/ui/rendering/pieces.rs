...
pub fn draw_piece(textures: &Textures, x: i32, y: i32, piece: Piece) {
    draw_texture_ex(
        ...
        (
            constants::ui::BOARD_RENDER_OFFSET.0 +
            x * constants::ui::SQUARE_SIZE +
            constants::ui::PIECE_PADDING
        ) as f32,
        (
            constants::ui::BOARD_RENDER_OFFSET.1 +
            y * constants::ui::SQUARE_SIZE +
            constants::ui::PIECE_PADDING
        ) as f32,
        WHITE,
        DrawTextureParams {
            dest_size: Some(Vec2::from((
                (constants::ui::SQUARE_SIZE - 2 * constants::ui::PIECE_PADDING) as f32,
                (constants::ui::SQUARE_SIZE - 2 * constants::ui::PIECE_PADDING) as f32,
            ))),
            ..Default::default()
        }
